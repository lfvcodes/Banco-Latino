...
const Transferir = () => {
  ...
  const directorioContacts = [
    { alias: "Amigo Juan", description: "Cuenta Ahorro", account_number: "9876-5432-1098-7654" },
    { alias: "Familia Maria", description: "Cuenta Corriente", account_number: "1122-3344-5566-7788" },
    { alias: "Negocio XYZ", description: "Cuenta Empresa", account_number: "2233-4455-6677-8899" },
  ];
