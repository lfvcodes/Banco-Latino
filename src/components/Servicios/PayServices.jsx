...
const PayServices = ({title,contract}) => {
...
const [cuenta, setCuenta] = useState("0123-4567-8901-2345");
  ...
  const directorioContacts = {
		"Recarga Telefonica":[
			{ alias: "Amigo Juan", description: "Cuenta Ahorro", account_number: "+584123456789" },
			{ alias: "Familia Maria", description: "Cuenta Corriente", account_number: "+551234567890" },
			{ alias: "Negocio XYZ", description: "Cuenta Empresa", account_number: "+1234567890" },
		],
		"Energía Eléctrica":[
			{ alias: "Luz Casa", description: "Cuenta Hogar", account_number: "3344-5566-7788-9900" },
			{ alias: "Luz Oficina", description: "Cuenta Oficina", account_number:	"4455-6677-8899-0011" },
		],
		"Agua":[
			{ alias: "Agua Casa", description: "Cuenta Hogar", account_number: "5566-7788-9900-1122" },
			{ alias: "Agua Oficina", description: "Cuenta Oficina", account_number: "6677-8899-0011-2233" }
		],
		"Internet":[
			{ alias: "Internet Casa", description: "Cuenta Hogar", account_number: "6677-8899-0011-2233" },
			{ alias: "Internet Oficina", description: "Cuenta Oficina", account_number: "7788-9900-1122-3344" },
		],
		"TV Cable":[
			{ alias: "TV Casa", description: "Cuenta Hogar", account_number: "8899-0011-2233-4455" },
			{ alias: "TV Oficina", description: "Cuenta Oficina", account_number: "9900-1122-3344-5566" },
		],
		"Gas":[
			{ alias: "Gas Casa", description: "Cuenta Hogar", account_number: "1010-2020-3030-4040" },
			{ alias: "Gas Oficina", description: "Cuenta Oficina", account_number: "2020-3030-4040-5050" },
		],
	};
  ...
  const transferir = (e) => {
	...
	console.log(directorioContacts);
          ...
          <div className="mt-0 border-2 border-blue-500 text-blue-800 rounded-lg w-full p-4">
            <div className="flex flex-col bg-transparent border-b-2 border-blue-200 pb-4 mb-4">
							<div className="block text-start mb-2">
								...
								<button type="button" className="bg-gray-500 text-white font-bold py-2 px-6 rounded-lg flex">
              ...
              <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                  <div className="font-bold text-gray-700">
                    <small>
                      Haga click en el directorio para seleccionar los
                      pagos frecuentes
                    </small>
                  </div>
                  <div className="flex justify-end md:justify-center"> {/* Alinea el botón a la derecha en móviles, a la izquierda en md+ */}
                    <button
                      type="button"
                            ...
                            <table className="min-w-full text-left divide-y divide-gray-200">
                              <thead className="bg-blue-50 border-b-2 border-blue-300 text-blue-700">
                                <tr>
                                  ...
                                  <th className="px-4 py-2 font-semibold">{title === 'Recarga Telefonica' ? 'Número de teléfono' : 'Número de contrato'}</th>
                                  <th className="px-4 py-2 font-semibold">Acción</th>
                                </tr>
                              </thead>
                              <tbody className="divide-y divide-gray-200">
                                {directorioContacts[title].map((contact, index) => (
              ...
              <form className="mt-6 space-y-4" onSubmit={transferir}>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center mb-4">
                  <label htmlFor="accountNumber" className="block text-gray-700 font-bold md:w-1/4 mb-1 md:mb-0">
                    {title === 'Recarga Telefonica' ?  "Número de Telefóno" : "Número de Contrato"}
                  </label>
									
                  <div className="w-full md:w-3/4">
                    <input
                      type="text"
                      className="form-input w-full md:w-3/4 border-none bg-gray-100 border-b-2 border-blue-500 text-gray-900 focus:outline-none focus:border-blue-700 p-2 rounded-md"
                      id="accountNumber"
                      value={accountNumber}
                      onChange={(e) => setAccountNumber(e.target.value)}
                    />
										<small id="alias" className="w-full text-center block text-gray-400 mt-1 ">
											{beneficiaryName ? (
								...
								{!beneficiaryName ? (
									<div className="flex flex-col items-center mb-4">
										<label htmlFor="checkFreq" className="flex items-center text-gray-700">
											...
											/>{" "}
											<span className="ml-2">Agregar a pago(s) frecuente(s)</span>
										</label>
									</div>
								) : ""}

                <div className="flex flex-col md:flex-row justify-between items-center mt-6 space-y-2 md:space-y-0 md:space-x-2">
                  <div className="w-full md:w-full gap-16 flex justify-center">
                    <button
                      onClick={resetForm}
                      type="button"
