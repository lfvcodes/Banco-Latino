...
const BalanceBar = ({ balance }) => {
  return (
    <div className="w-full mx-auto grid md:grid-cols-1 gap-2">
      <a
        href={"/dashboard/home"}
        title="Balance"
        className="flex grid md:grid-cols-2 bg-green-200 rounded-lg shadow-md p-4 px-16 hover:shadow-lg transition"
      >
